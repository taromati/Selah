...
import me.taromati.almah.core.exception.ApiException;
...
public class RootResponse<T> {
    ...
    public static RootResponse<Void> ok(String message) {
        return new RootResponse<>(ResponseCode.SUCCESS.getCode(), message);
    }

    public static RootResponse<Void> fail(String message) {
        return new RootResponse<>(ResponseCode.FAIL.getCode(), message);
    }
}
