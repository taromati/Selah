...
public class StructuredQueryService {
    ...
    private static final String SCHEMA_INFO = """
            Available tables:
            - memory_chunks(id TEXT PK, content TEXT, tokenized TEXT, source_id VARCHAR(36), chunk_index INTEGER, total_chunks INTEGER, consolidated BOOLEAN, metadata TEXT, embedding BLOB, created_at TEXT, graph_processed BOOLEAN, graph_processed_at TEXT)
