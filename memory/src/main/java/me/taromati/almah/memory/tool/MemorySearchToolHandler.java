...
import me.taromati.almah.memory.HybridSearch;
...
public class MemorySearchToolHandler {
    ...
    private ToolResult execute(String argumentsJson) {
        try {
            ...
            List<HybridSearch.SearchResult> results = memoryService.search(query);
            ...
            for (int i = 0; i < results.size(); i++) {
                HybridSearch.SearchResult result = results.get(i);
