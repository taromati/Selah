...
public class TaskPromptBuilder {
    ...
    public String build(AgentTaskItemEntity task) {
        ...
        // 자기 평가 지시
        sb.append("---\n## 자기 평가\n");
        sb.append("작업을 수행한 후 아래 블록으로 완료 여부를 평가하세요.\n");
        sb.append("- 목표를 달성했으면: [SELF_EVAL: PASS]\n");
        sb.append("- 일부만 완료했으면: [SELF_EVAL: PARTIAL] 사유\n");
        sb.append("- 달성이 불가능하면: [SELF_EVAL: FAIL] 사유\n\n");
