...
public class WebFetchToolHandler {
    ...
    public WebFetchToolHandler(ToolRegistry toolRegistry, AgentConfigProperties config, ObjectMapper objectMapper) {
    ...
    @PostConstruct
    void register() {
        toolRegistry.register("web_fetch", DEFINITION, this::execute, true, "웹");
    }
